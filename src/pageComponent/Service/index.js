  ...
  return (
    <div>
      <div className='content'>
        <h2 className='heading-1 mdpt-[14.755vw] lg:pt-[9.755vw] pt-[23.53vw] md:mb-0 mb-[4.27vw]'>{namePage?.name}</h2>
        <FilterService
        ...
        {!loading ? (
          <div>
            {pageInfo !== 0 ? (
              ...
              <div className='md:px-[8.06vw] px-[4.27vw] md:mt-[4vw] mt-[7.73vw] text-center text-[3.5vw] pt-[4vw] w-full font-optima max-md:text-[5.67vw]'>
          ...
          listBestTour?.length !== 0 && (
            <div>
              ...
              <div className='md:px-[8.06vw]'>
                <SlideTour
                  data={dataBestTour?.data?.allTours?.nodes}
                  lang={lang}
                />
              </div>
              <Link
              ...
              >
                <Button
                  content={data1?.data?.page?.translation?.ourblog?.button}
